                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#user_with_icon_title" data-toggle="tab" aria-expanded="true">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="user_with_icon_title">
                                    <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <form class="form-horizontal" action="{{ route('author.profile.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="email" type="text" id="email" class="form-control" placeholder="Enter your email" value="{{ Auth::user()->email }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
